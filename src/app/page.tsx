      ...
      <div className={styles.page}>
        <main className={styles.main}>
          <div className={styles.header_container}>
            ...
            <div className={styles.description}>I build mobile first responsive web pages. <div className={styles.resume_container}>View my<a className={styles.resume} href={"/Lian_Thompson_Resume_2026.pdf"} target="_blank">résumé<div className={styles.dash_small}></div><Image className={styles.arrow} src="/icons8-right-arrow-24.png" alt="resume" height={16} width={16} /></a></div></div>
